...
calibDate      = datetime('2013-07-03');   % change this to any date you want
...
validIV = ~isnan(MarketIVVec) & MarketIVVec > 0.08 & MarketIVVec < 0.40;
...
lb = [0.001  0.001  0.1   0.05   -0.99];
ub = [0.10   0.10   15.0  1.0     0.99];  % much tighter — QQQ is low vol

startPoints = [0.01   0.02   2.0   0.2   -0.5;
               0.02   0.03   4.0   0.3   -0.4;
               0.01   0.02   6.0   0.4   -0.6;
               0.02   0.04   8.0   0.5   -0.3;
               0.01   0.03   10.0  0.6   -0.5];
...
BarrierOpt = fininstrument("Barrier", ...
    'Strike',        73, ...   % ATM for NVDA July 2023
    'ExerciseDate',  ExerciseDate, ...
    'OptionType',    "call", ...
    'ExerciseStyle', "american", ...
    'BarrierType',   "DO", ...
    'BarrierValue',  60);      % ~80% of spot
